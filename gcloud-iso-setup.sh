...
echo "   if [ -d \"Homelab-Install-Script\" ]; then"
echo "       cd Homelab-Install-Script && git pull"
echo "   else"
echo "       git clone https://github.com/brilliantsquirrel/Homelab-Install-Script.git"
echo "       cd Homelab-Install-Script"
echo "   fi"
echo ""
echo "5. Download dependencies (on VM, ~1-1.5 hours):"
echo "   bash iso-prepare.sh"
echo ""
echo "6. Build the custom ISO (on VM, ~30-45 minutes):"
echo "   bash create-custom-iso.sh"
echo ""
echo "NOTE: Use 'bash script.sh' instead of './script.sh' because gcsfuse doesn't support chmod"
echo ""
